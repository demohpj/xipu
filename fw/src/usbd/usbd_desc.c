...
#define USBD_PID                      22314  /* Replace '0xaaaa' with your device product ID */
...
#define USBD_PRODUCT_HS_STRING        "STM32 Mass Storage" /* Add your product High Speed string */
#define USBD_PRODUCT_FS_STRING        "STM32 Mass Storage" /* Add your product Full Speed string */
#define USBD_CONFIGURATION_HS_STRING  "MSC Config" /* Add your configuration High Speed string */
#define USBD_INTERFACE_HS_STRING      "MSC Interface" /* Add your Interface High Speed string */
