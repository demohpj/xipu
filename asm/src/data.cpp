...
{
	for(const QSharedPointer<CodeSection> &codeSectionFor : this->codeSectionList)
	{
...
{
	for(const QSharedPointer<RamItem> &ramItemFor : this->ramItemList)
	{
	...
	for(const QSharedPointer<FlashItem> &flashItemFor : this->flashItemList)
	{
