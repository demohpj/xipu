...
{
	for(const QSharedPointer<CodeSection> &codeSectionFor : this->globalCodeSectionList)
	{
...
{
	for(const QSharedPointer<RamItem> &ramItemFor : this->globalRamItemList)
	{
	...
	for(const QSharedPointer<FlashItem> &flashItemFor : this->globalFlashItemList)
	{
